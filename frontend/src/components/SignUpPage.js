...
export default function SignUpPage() {
    ...
    const handleSignUp = async () => {
        ...
        try {
            const response = await axios.post('https://hostel-hunt-1.onrender.com/api/auth/signup', {
                email,
                password,
                name,
                gender,
    ...
    const handleVerifyOtp = async () => {
        try {
            const response = await axios.post('https://hostel-hunt-1.onrender.com/api/auth/verify-otp', {
                email,
                otp,
                userExists,
